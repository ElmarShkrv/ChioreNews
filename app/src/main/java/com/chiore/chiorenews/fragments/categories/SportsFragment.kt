...
class SportsFragment: BaseCategoryFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.latestNewsBySports.observe(viewLifecycleOwner) { sportsNewsResponse ->
            latestNewsRvAdapter.submitData(viewLifecycleOwner.lifecycle, sportsNewsResponse)
        }
    }
}